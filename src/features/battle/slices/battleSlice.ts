...
const battleSlice = createSlice({
  ...
  reducers: {
    ...
    setStatus: (
      state,
      action: PayloadAction<"waiting" | "in-progress" | "completed">,
    ) => {
    ...
    updatePlayerCode: (
      state,
      action: PayloadAction<{ playerId: string; code: string }>,
    ) => {
    ...
    updatePlayerLanguage: (
      state,
      action: PayloadAction<{ playerId: string; language: string }>,
    ) => {
