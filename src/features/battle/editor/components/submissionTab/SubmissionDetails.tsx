...
const SubmissionDetails: React.FC<SubmissionDetailsProps> = ({
  ...
  const submissionDetails = useSelector(
    (state: RootState) => state.submissions.selectedSubmission,
  );
              ...
              {submissionDetails ? (
                <>
                  <div className="text-sm">
                    {new Date(submissionDetails.createdAt)
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-sm">
                      {getStatusText(submissionDetails.status)}
                    </span>
                  </div>
                  <div className="text-sm">{submissionDetails.score}</div>
                </>
              ) : (
                <>
