        ...
        <div>
          <div className="flex justify-between items-start mb-2">
            <div>
              ...
              <p className="text-gray-400 text-sm">Control who can view your profile and activity details</p>
            </div>
            <div className="flex gap-2">
              <button className="px-4 py-2 rounded bg-[#282C34] text-white">Private</button>
              <button className="px-4 py-2 rounded text-gray-400">Public</button>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between items-start mb-2">
            <div>
              ...
              <p className="text-gray-400 text-sm">Manage whether others can find you by your email or username</p>
            </div>
        ...
        <div>
          <div className="flex justify-between items-start mb-2">
            <div>
              ...
              <p className="text-gray-400 text-sm">Review and manage the devices currently accessing your account.</p>
            </div>
