      ...
      {problems.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full p-4">
          ...
          <p className="text-gray-400 mt-2 md:mt-4 text-center text-sm md:text-base px-2">
            You haven&apos;t added any problems to this contest yet. Start by adding one now!
          </p>
        </div>
      ) : (
        <div className="bg-[#1A1D24] rounded-lg overflow-hidden w-full">
          ...
          <div className="grid grid-cols-6 md:grid-cols-8 p-3 md:p-4 text-white border-b border-gray-700 text-sm md:text-base">
            ...
            <div className="col-span-2 md:col-span-2 text-center">Max Score</div>
            <div className="hidden md:block col-span-1 text-center">Rating</div>
          </div>
            ...
            {problems.map((problem, index) => (
              ...
              >
                ...
                <div className="col-span-1 flex items-center justify-end md:justify-between">
                  <span className="hidden md:block flex-1 text-center text-white/80">{problem.rating}</span>
    ...
    {showDeleteConfirm && (
      <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
        <div className="bg-[#1A1D24] p-4 md:p-6 rounded-lg w-full max-w-xs md:max-w-md">
          <h3 className="text-base md:text-lg font-medium mb-2 md:mb-4">Delete Problem</h3>
          <p className="text-gray-400 text-sm md:text-base mb-4 md:mb-6">Are you sure you want to delete this problem?</p>
